...
_ID_SERVICE_HINTS: dict[str, list[str]] = {
    "buyerId": ["Customer", "customer"],
    "customerId": ["Customer", "customer"],
    "userId": ["Customer", "customer", "User"],
    "recipientId": ["Customer", "customer"],
    "accountId": ["Customer", "customer", "Billing", "Account"],
    "orderId": ["Order"],
    "warehouseId": ["Inventory", "Warehouse"],
    "carrierId": ["Shipping", "Carrier", "Delivery"],
    "shipmentId": ["Shipping", "Shipment", "Delivery"],
    "trackingNumber": ["Shipping", "Delivery"],
    "invoiceId": ["Billing", "Invoice"],
    "paymentId": ["Billing", "Payment"],
